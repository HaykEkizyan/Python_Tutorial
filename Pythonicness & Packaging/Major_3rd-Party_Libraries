...
It has many useful features, and whatever features it lacks are covered by extension packages.
...
While Python does offer modules for programmatically accessing websites, such as urllib, they are quite cumbersome to use.
