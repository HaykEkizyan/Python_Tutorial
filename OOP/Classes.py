...
The class describes what the object will be, but is separate from the object itself. In other words, 
...
me = Person("Hayk Ekizyan")
me.talk()                                     # Hi, I'm Hayk Ekizyan
john = Person("John Smith")
john.talk()                                   # Hi, I'm John Smith                                 
...
me = Person("Hayk Ekizyan", 30)
me.talk()                                                         # Hi, I'm Hayk Ekizyan and I'm 30
john = Person("John Smith", 25)
john.talk()                                                       # Hi, I'm John Smith and I'm 25
...
class Person:
    ...
    def talk(self):
        print(f"Hi, I'm {self.name} and I'm {self.age}")
me = Person("Hayk Ekizyan", 30)
print(me.hair_color)                                              # black
john = Person("John Smith", 25)
print(john.hair_color)                                            # black
